...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = {\n  data: function data() {\n    return {\n      screenHeight: '',\n      screenwidth: '',\n      src: '',\n      //切换账密登录/手机验证码注册/手机验证码登录\n      index: 1,\n      //注册栏目填入的手机号\n      regist_phone: '',\n      //注册栏目填入的手机验证码\n      regist_code: '',\n      //注册栏目填入的密码\n      regist_password: '',\n      //登录栏目填入的年龄\n      regist_age: \"\",\n      //登录栏目填入的手机号\n      login_phone: '',\n      //登录栏目填入的密码\n      login_password: '',\n      //验证码登录栏目填入的手机号\n      codelogin_phone: '',\n      //验证码登录栏目填入的验证码\n      codelogin_code: ''\n    };\n  },\n  methods: {\n    toRegist: function toRegist() {\n      this.index = 2;\n      __f__(\"log\", \"index: \" + this.index, \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:144\");\n    },\n    tologin: function tologin() {\n      this.index = 1;\n      __f__(\"log\", \"index: \" + this.index, \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:148\");\n    },\n    toByCode: function toByCode() {\n      this.index = 3;\n      __f__(\"log\", \"index: \" + this.index, \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:152\");\n    },\n    sendCode: function sendCode() {\n      if (this.regist_phone == \"\") {\n        __f__(\"log\", \"请输入正确的手机号\", \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:156\");\n        return;\n      }\n      //发送短信验证码\n      uni.request({\n        url: getApp().globalData.envprefix + '/admin-api/system/auth/send-sms-code',\n        method: 'POST',\n        header: {\n          'tenant-id': 1,\n          'scene': 4\n        },\n        data: {\n          'mobile': this.regist_phone\n        },\n        success: function success(res) {\n          if (res.data.code != 200) {\n            __f__(\"log\", \"验证码发送失败\", \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:172\");\n            __f__(\"log\", res.data.code, \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:173\");\n            uni.showToast({\n              icon: 'none',\n              title: \"验证码发送失败\"\n            });\n            return;\n          }\n          uni.showToast({\n            icon: 'none',\n            title: \"验证码已发送\"\n          });\n        },\n        fail: function fail() {},\n        complete: function complete() {}\n      });\n    },\n    sendCodeLogin: function sendCodeLogin() {\n      if (this.codelogin_phone == \"\") {\n        __f__(\"log\", \"请输入正确的手机号\", \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:191\");\n        return;\n      }\n      //发送短信验证码\n      uni.request({\n        url: getApp().globalData.envprefix + '/admin-api/system/auth/send-sms-code',\n        method: 'POST',\n        header: {\n          'tenant-id': 1\n        },\n        data: {\n          'mobile': this.codelogin_phone,\n          'scene': 21\n        },\n        success: function success(res) {\n          if (res.data.code != 200) {\n            __f__(\"log\", \"验证码发送失败\", \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:207\");\n            __f__(\"log\", res.data.code, \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:208\");\n            uni.showToast({\n              icon: 'none',\n              title: \"验证码发送失败\"\n            });\n            return;\n          }\n          uni.showToast({\n            icon: 'none',\n            title: \"验证码已发送\"\n          });\n        },\n        fail: function fail() {},\n        complete: function complete() {}\n      });\n    },\n    loginByCode: function loginByCode() {\n      var that = this;\n\n      //先进行判断\n      if (this.codelogin_code == \"\" || this.codelogin_phone == \"\") {\n        uni.showToast({\n          icon: 'none',\n          title: \"请输入正确的内容\"\n        });\n        return;\n      }\n\n      //发起验证码登录请求\n      uni.request({\n        url: getApp().globalData.envprefix + \"/admin-api/system/auth/sms-login\",\n        method: 'POST',\n        header: {\n          'tenant-id': 1\n        },\n        data: {\n          'code': that.codelogin_code,\n          'mobile': that.codelogin_phone\n        },\n        success: function success(res) {\n          if (res.data.code != 200) {\n            __f__(\"log\", res.data.code, \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:249\");\n            __f__(\"log\", \"验证码登录失败\", \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:250\");\n            uni.showToast({\n              icon: 'none',\n              title: \"验证码登录失败\"\n            });\n            return;\n          }\n          __f__(\"log\", \"验证码登录成功\", \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:257\");\n          //将userId传入全局变量\n          getApp().globalData.userId = res.data.data.userId;\n          //将token存入全局变量\n          getApp().globalData.accessToken = res.data.data.accessToken;\n          //提示登陆成功\n          uni.showToast({\n            icon: 'none',\n            title: \"登录成功\"\n          });\n          //跳转到首页\n          uni.switchTab({\n            url: \"/pages/HomePage/HomePage\"\n          });\n        }\n      });\n    },\n    regist: function regist() {\n      var that = this;\n\n      //发起注册请求\n      if (this.regist_code == \"\" || this.regist_password == \"\" || this.regist_age == \"\") {\n        //非空判断\n        uni.showToast({\n          icon: 'none',\n          title: \"请输入正确的内容\"\n        });\n        return;\n      }\n      //年龄正确性判断\n      if (!this.isNum(this.regist_age)) {\n        //非数字\n        uni.showToast({\n          icon: 'none',\n          title: \"年龄应为数字\"\n        });\n        return;\n      }\n      if (Number(this.regist_age) <= 0 || Number(this.regist_age) > 150) {\n        //年龄输入不正常\n        uni.showToast({\n          icon: 'none',\n          title: \"年龄范围为1~150\"\n        });\n        return;\n      }\n      //判断完毕,可以发起注册请求\n      uni.request({\n        url: getApp().globalData.envprefix + \"/admin-api/system/auth/register-sms\",\n        method: 'POST',\n        header: {\n          'tenant-id': 1\n        },\n        data: {\n          'code': that.regist_code,\n          'password': that.regist_password,\n          'mobile': that.regist_phone,\n          'age': that.regist_age\n        },\n        success: function success(res) {\n          if (res.data.code != 200) {\n            __f__(\"log\", res.data.code, \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:316\");\n            __f__(\"log\", \"注册请求失败\", \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:317\");\n            return;\n          }\n          __f__(\"log\", \"注册请求发起成功\", \" at pages/LoginAndRegistPage/subNvue/subNvue.nvue:320\");\n          uni.showToast({\n            icon: 'none',\n            title: \"注册成功!\"\n          });\n          //处理数据\n          getApp().globalData.userAge = that.regist_age;\n          that.regist_code = \"\";\n          that.regist_password = \"\";\n          that.regist_phone = \"\";\n          that.regist_age = \"\";\n        }\n      });\n    },\n    //校验是否为数字的方法（正负整数，正负浮点数以及0）,是数字则返回true\n    isNum: function isNum(val) {\n      var regPos = /^[0-9]+.?[0-9]*/;\n      if (regPos.test(val)) {\n        return true;\n      } else {\n        return false;\n      }\n    },\n    login: function login() {\n      var that = this;\n      //发起登录请求\n      uni.request({\n        url: getApp().globalData.envprefix + '/admin-api/system/auth/login',\n        method: 'POST',\n        header: {\n          'tenant-id': 1\n        },\n        data: {\n          \"captchaVerification\": \"\",\n          \"password\": that.login_password,\n          \"username\": that.login_phone\n        },\n        success: function success(res) {\n          if (res.data.data.userId != undefined) {\n            //将userId传入全局变量\n            getApp().globalData.userId = res.data.data.userId;\n            //将token存入全局变量\n            getApp().globalData.accessToken = res.data.data.accessToken;\n            //提示登陆成功\n            uni.showToast({\n              icon: 'none',\n              title: \"登录成功\"\n            });\n            //跳转到首页\n            uni.switchTab({\n              url: \"/pages/HomePage/HomePage\"\n            });\n          }\n        }\n      });\n    }\n  },\n  onLoad: function onLoad() {\n    //若用户已经登录，则不需要跳转到此页面\n    // if(getApp().globalData.userId!=\"\" && getApp().globalData.accessToken!=\"\"){\n    // \tconsole.log(\"用户已经登陆，userId：\" + getApp().globalData.userId);\n    // \tuni.switchTab({\n    // \t\turl:\"/pages/HomePage/HomePage\"\n    // \t})\n    // }\n  }\n};\nexports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 10)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///9\n");
